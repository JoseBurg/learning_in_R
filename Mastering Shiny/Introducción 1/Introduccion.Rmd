...
`choiceNames` determina lo que se muestra al usuario y `choiceValues` determina lo que se devuelce en su función de servidor.
...
- `selecIpunt()` es mas adecuado para listas largas, ya que despega un menú más elegante. Ademas, con el argumento de `multiple = TRUE` el usuario puede selecionar más de una opcion.
